...
public class ItemController {
    ...
    @PostMapping
    public ItemDto addItem(@RequestHeader(CONST_SHARED_USER_ID) Long userId, @Valid @RequestBody ItemDto itemDto) {
    ...
    @PatchMapping("/{itemId}")
    public ItemDto updateItem(@PathVariable Long itemId, @RequestHeader(CONST_SHARED_USER_ID) Long userId, @Valid @RequestBody ItemUpdateDto itemUpdateDto) {
    ...
    @GetMapping("/{itemId}")
    public ItemDto getItem(@PathVariable Long itemId, @RequestHeader(CONST_SHARED_USER_ID) Long userId) {
    ...
    @GetMapping
    public List<ItemDto> getItems(@RequestHeader(CONST_SHARED_USER_ID) Long userId,
    ...
    public CommentDto addComment(@RequestHeader(CONST_SHARED_USER_ID) Long userId, @PathVariable Long itemId, @Valid @RequestBody CommentDto commentDto) {
